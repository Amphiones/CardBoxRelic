...
public class CardBox extends CustomRelic {
    public static final String ID = "CardBox";
    private static final String IMG = "images/relics/CardBox.png";
    private static final String OUTLINE = "images/relics/outline/CardBox.png";
